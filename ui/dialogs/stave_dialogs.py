...
class StavesDialog(QDialog):
    ...
    def __init__(self, staves: list[Stave], parent: QWidget | None = None) -> None:
        ...
        setting_controls = QVBoxLayout()
        setting_controls.addWidget(self._name_button, alignment=Qt.AlignmentFlag.AlignLeft)
        setting_controls.addWidget(self._range_button, alignment=Qt.AlignmentFlag.AlignLeft)
        setting_controls.addWidget(self._scale_button, alignment=Qt.AlignmentFlag.AlignLeft)
        setting_controls.addWidget(self._left_margin_button, alignment=Qt.AlignmentFlag.AlignLeft)
        setting_controls.addWidget(self._right_margin_button, alignment=Qt.AlignmentFlag.AlignLeft)
        setting_scope_label = QLabel(
            "These settings apply globally to every system and overwrite local page adjustments.",
            self,
        )
        setting_scope_label.setWordWrap(True)
        setting_scope_label.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        settings_layout = QHBoxLayout()
        settings_layout.addLayout(setting_controls)
        settings_layout.addWidget(setting_scope_label, 1)
